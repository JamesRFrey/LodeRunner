...
import com.loderunner.game.world.customgamemap.CustomGameMapData;
import com.loderunner.game.world.customgamemap.CustomGameMapLoader;
...
public class CustomGameMap extends GameMap {
	...
	public TileType getTileTypeByLocation(int layer, float x, float y) {
		return this.getTileTypeByCoordinate(layer, (int)(x / TileType.TILE_SIZE), getHeight() - (int)(y / TileType.TILE_SIZE));
	}
